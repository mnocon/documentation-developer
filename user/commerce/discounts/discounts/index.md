...
Increase conversion and attract customers by offering them products at discounted prices.
...
![Cart with discount](https://doc.ibexa.co/projects/userguide/en/5.0/commerce/img/discount_cart.png)

Depending on the permissions assigned to your [user role](../../../permission_management/permissions_and_users/index.md), you might be able to view existing discounts or define new ones to shape the pricing policy of your store.
...
For more information about discounts, see [Work with discounts](../work_with_discounts/index.md).

...
>
> Before you add a block that uses results derived from a [Personalization](https://doc.ibexa.co/projects/userguide/en/5.0/personalization/personalization/index.md) scenario, for example, [Dynamic targeting](../block_reference/index.md#dynamic-targeting-block) or [Recently added block](../block_reference/index.md#recently-added-block), make sure that the scenario is [properly configured](https://doc.ibexa.co/projects/userguide/en/5.0/personalization/configure_scenarios/index.md).

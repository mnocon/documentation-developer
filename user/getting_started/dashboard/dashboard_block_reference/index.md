...
## Top 10 clicked items block (Experience, Commerce)

Requires [Ibexa Personalization](https://doc.ibexa.co/projects/userguide/en/5.0/personalization/personalization/index.md) enabled.

Displays a table presenting top 10 clicked items.

Table contains following columns: Item clicked (including item name), Item type, Recommended (presenting number of recommendations of selected item), Clicked (presenting total number of clicks on selected item).

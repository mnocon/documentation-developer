...
>
> By default, log entries are kept for 30 days. This time can be modified through configuration. For more information, see [Developer Documentation](../../../developer/administration/recent_activity/recent_activity/index.md#configuration-and-cronjob).
